...
st.set_page_config(page_title="Compare AI Models", layout="wide")
...
with colA:
   st.session_state["model_a"] = st.selectbox(
       "Model A", 
       ["openai/gpt-oss-20b", "llama-3.3-70b-versatile", "moonshotai/kimi-k2-instruct-0905","groq/compound-mini"], 
       index=0, 
       key=1
    )
